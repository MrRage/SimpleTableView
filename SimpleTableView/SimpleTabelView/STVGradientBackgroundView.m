...
#define TABLECELLBACKGROUND    { 1, 1, 1, 1, 0.866, 0.866, 0.866, 1}			// #FFFFFF and #DDDDDD
...
@implementation STVGradientBackgroundView
...
-(void)drawRect:(CGRect)aRect {
    ...
    CGFloat components[8] = TABLECELLBACKGROUND;
    CGContextSetStrokeColorWithColor(c, [[UIColor grayColor] CGColor]);
    CGContextSetLineWidth(c, lineWidth);
    CGContextSetAllowsAntialiasing(c, YES);
    CGContextSetShouldAntialias(c, YES);
    
    if (position == kSTVCellBackgroundPositionTop) {
    ...
    } else if (position == kSTVCellBackgroundPositionBottom) {
    ...
    } else if (position == kSTVCellBackgroundPositionMiddle) {
    ...
    } else if (position == kSTVCellBackgroundPositionSingle) {
        miny += 1;
...
- (void)setPosition:(STVCellBackgroundPosition)newPosition {
